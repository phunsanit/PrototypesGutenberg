...
var getInserterItems = (0, _rememo.default)(function (state) {
  ...
  return (0, _lodash.orderBy)([].concat((0, _toConsumableArray2.default)(blockTypeInserterItems), (0, _toConsumableArray2.default)(reusableBlockInserterItems)), ['frecency'], ['desc', 'desc']);
}, function (state, rootClientId) {
