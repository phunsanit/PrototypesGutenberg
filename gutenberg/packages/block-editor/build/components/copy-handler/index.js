...
function CopyHandler(_ref) {
  ...
  var handler = function handler(event) {
    ...
    if (!hasMultiSelection()) {
      ...
      var hasSelection = event.type === 'copy' || event.type === 'cut' ? (0, _dom.documentHasTextSelection)() : (0, _dom.documentHasSelection)(); // Let native copy behaviour take over in input fields.
