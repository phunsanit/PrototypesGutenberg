...
var horizontalMover = {
  ...
  firstBlockTitle: (0, _i18n.__)('Move %s Left'),

  /* translators: %s: block title e.g: "Paragraph" */
  lastBlockTitle: (0, _i18n.__)('Move %s Right'),
...
var verticalMover = {
  ...
  /* translators: %s: block title e.g: "Paragraph" */
  firstBlockTitle: (0, _i18n.__)('Move %s Up'),

  /* translators: %s: block title e.g: "Paragraph" */
  lastBlockTitle: (0, _i18n.__)('Move %s Down'),
...
function getMoverActionTitle(isStackedHorizontally, _ref2) {
  var blockTitle = _ref2.blockTitle;
  ...
  return {
    backward: (0, _i18n.sprintf)(actionTitlePrev, blockTitle),
    forward: (0, _i18n.sprintf)(actionTitleNext, blockTitle)
  };
}

function getMoverButtonTitle(isStackedHorizontally, _ref3) {
  ...
  var args = [backwardButtonTitle, forwardButtonTitle, isStackedHorizontally];
