...
var __experimentalPageTemplatePicker = function __experimentalPageTemplatePicker(_ref) {
  ...
  var shouldShowTooltip = function shouldShowTooltip() {
    (0, _reactNativeGutenbergBridge.requestStarterPageTemplatesTooltipShown)(function (tooltipShown) {
      if (!tooltipShown) {
        setTooltipVisible(true);
        (0, _reactNativeGutenbergBridge.setStarterPageTemplatesTooltipShown)(true);
      }
    });
  };
