...
import { Button, Dropdown, ToolbarGroup, __experimentalAlignmentMatrixControl as AlignmentMatrixControl } from '@wordpress/components';
export function BlockAlignmentMatrixToolbar(props) {
  ...
  return createElement(Dropdown, {
    ...
    renderToggle: function renderToggle(_ref) {
      ...
      return createElement(ToolbarGroup, null, createElement(Button, {
        onClick: onToggle,
        "aria-haspopup": "true",
