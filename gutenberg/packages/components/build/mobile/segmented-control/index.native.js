...
var SegmentedControls = function SegmentedControls(_ref2) {
  ...
  function onHandlePress(segment, index) {
    _reactNative.LayoutAnimation.configureNext(_reactNative.LayoutAnimation.create(ANIMATION_DURATION, _reactNative.LayoutAnimation.Types.easeInEaseOut, _reactNative.LayoutAnimation.Properties.opacity));
