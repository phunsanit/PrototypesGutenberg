...
function singleEnableItems() {
  ...
  if (!item && !(0, _lodash.get)(_defaults.DEFAULTS.enableItems.singleEnableItems, [itemType, scope])) {
    var newTypeState = (0, _lodash.omit)(state[itemType], [scope]);
    return (0, _lodash.isEmpty)(newTypeState) ? (0, _lodash.omit)(state, [itemType]) : _objectSpread({}, state, (0, _defineProperty2.default)({}, itemType, newTypeState));
  }
...
var _default = (0, _lodash.flow)([_data.combineReducers, createWithInitialState(_defaults.DEFAULTS)])({
