...
function installBlockType(_ref) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          throw new Error((0, _i18n.__)('Unable to install this block.'));
        ...
        case 20:
          ...
          throw new Error((0, _i18n.__)('Unable to get block types.'));
        ...
        case 26:
          ...
          _context.next = 30;
          return setErrorNotice(id, _context.t0.message || (0, _i18n.__)('An error occurred.'));
...
function setIsInstalling(isInstalling) {
  return {
