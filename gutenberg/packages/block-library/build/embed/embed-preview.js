...
var EmbedPreview = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(EmbedPreview, [{
    ...
    value: function render() {
      ...
      var cannotPreview = (0, _lodash.includes)(_constants.HOSTS_NO_PREVIEWS, parsedHostBaseUrl);
      ...
      (0, _i18n.__)("Embedded content from %s can't be previewed in the editor."), parsedHostBaseUrl))) : embedWrapper, (!_blockEditor.RichText.isEmpty(caption) || isSelected) && (0, _element.createElement)(_blockEditor.RichText, {
        tagName: "figcaption",
