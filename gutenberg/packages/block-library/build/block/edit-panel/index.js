...
var ReusableBlockEditPanel = /*#__PURE__*/function (_Component) {
  ...
  function ReusableBlockEditPanel() {
    ...
    _this.handleTitleChange = _this.handleTitleChange.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleTitleKeyDown = _this.handleTitleKeyDown.bind((0, _assertThisInitialized2.default)(_this));
    return _this;
  }
