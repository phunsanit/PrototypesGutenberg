...
function CoverEdit(_ref3) {
  ...
  var controls = createElement(Fragment, null, createElement(BlockControls, null, createElement(BlockAlignmentMatrixToolbar, {
  ...
  }), hasBackground && createElement(MediaReplaceFlow, {
    mediaId: id,
    mediaURL: url,
