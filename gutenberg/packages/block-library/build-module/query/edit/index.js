...
export default function QueryEdit(_ref) {
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(QueryToolbar, {
    query: query,
  ...
  })), createElement(QueryProvider, null, createElement(InnerBlocks, {
    template: TEMPLATE
  })));
}
