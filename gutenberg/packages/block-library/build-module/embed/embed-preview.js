...
var EmbedPreview = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EmbedPreview, [{
    ...
    value: function render() {
      ...
      var cannotPreview = includes(HOSTS_NO_PREVIEWS, parsedHostBaseUrl);
      ...
      __("Embedded content from %s can't be previewed in the editor."), parsedHostBaseUrl))) : embedWrapper, (!RichText.isEmpty(caption) || isSelected) && createElement(RichText, {
        tagName: "figcaption",
