...
shortcode, archives, audio, button, calendar, categories, code, columns, column, cover, embed].concat(_toConsumableArray(embed.common), _toConsumableArray(embed.others), [file, html, mediaText, latestComments, latestPosts, missing, more, nextpage, preformatted, pullquote, rss, search, separator, reusableBlock, spacer, subhead, table, tagCloud, textColumns, verse, video, classic, buttons]).reduce(function (accumulator, block) {
