...
function _insertBlock() {
  _insertBlock = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee7(searchTerm) {
    var insertButton;
...
function insertPattern(_x4) {
  return _insertPattern.apply(this, arguments);
}

function _insertPattern() {
  _insertPattern = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee8(searchTerm) {
    var insertButton;
