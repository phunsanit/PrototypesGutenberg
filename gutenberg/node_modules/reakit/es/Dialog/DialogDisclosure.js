...
var useDialogDisclosure = createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    useIsomorphicEffect(function () {
      ...
      process.env.NODE_ENV !== "production" ? warning(!self, "Can't determine whether the element is the current disclosure because `ref` wasn't passed to the component", "See https://reakit.io/docs/dialog") : void 0;
