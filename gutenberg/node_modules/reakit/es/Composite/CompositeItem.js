...
import '../Box/Box.js';
import { a as _objectSpread2, _ as _objectWithoutPropertiesLoose, b as _createForOfIteratorHelperLoose } from '../_rollupPluginBabelHelpers-419c3ce6.js';
...
import { u as unstable_useCompositeState, g as getCurrentId } from '../CompositeState-0df9c8f7.js';
...
var unstable_useCompositeItem = createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    var onFocus = useCallback(function (event) {
      ...
      if (!id) return;
      if (targetIsAnotherItem(event, options.items)) return; // Using originalCurrentId because currentId may be different due to
