...
var useDialogDisclosure = createHook.createHook({
  ...
  useProps: function useProps(options, _ref) {
    ...
    useIsomorphicEffect.useIsomorphicEffect(function () {
      ...
      process.env.NODE_ENV !== "production" ? reakitWarning.warning(!self, "Can't determine whether the element is the current disclosure because `ref` wasn't passed to the component", "See https://reakit.io/docs/dialog") : void 0;

      if (disclosureRef && !disclosureRef.current) {
        disclosureRef.current = self;
      }

      var isCurrentDisclosure = !(disclosureRef === null || disclosureRef === void 0 ? void 0 : disclosureRef.current) || disclosureRef.current === self;
