    ...
    case "unregisterItem":
      {
        ...
        if (currentId && currentId === _id2) {
          var nextId = getCurrentId(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, nextState), {}, {
    ...
    case "previous":
      {
        ...
        var _nextState = reducer(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
          items: reverse(items)
    ...
    case "down":
      {
        ...
        var _nextState2 = reducer(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, state), {}, {
...
function unstable_useCompositeState(initialState) {
  ...
  var idState = IdState.unstable_useIdState(sealed); // When currentId is undefined, set it to the first enabled item.
